...
func main() {
	...
	if err := http.ListenAndServe(*addr, sentryx.NewRelayWithConfig(*upstream, sentryx.DefaultMaxEnvelopeBytes, os.Getenv("SENTRYX_RELAY_TOKEN"), sentryx.PIIConfigFromEnv())); err != nil {
